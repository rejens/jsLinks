...
//sales transactions
const sellingFrom=$("#datepicker-sellingTransaction-from").val()
const sellingTo=$("#datepicker-sellingTransaction-to").val()

// $.ajax({
//     type: "post",
//     url: URLROOT+"api/salesTransaction.php",
//     dataType: "json",
//     data:{ sellingFrom :sellingFrom,
//             sellingTo:sellingTo
//     },
//     success: function (response) {
//         data=``;
...
$(".datepicker-selling").on("input",function(){
